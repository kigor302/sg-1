...
void SSD1306_DrawEmptyRect( struct SSD1306_Device* DeviceHandle, int x, int y, int x2, int y2, bool Color ) {
    NullCheck( DeviceHandle, return );
    NullCheck( DeviceHandle->Framebuffer, return );
    ...
    SSD1306_DrawVLine( DeviceHandle, x, y, y2, Color );
    SSD1306_DrawVLine( DeviceHandle, x2, y, y2, Color );
}
